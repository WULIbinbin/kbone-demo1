...
function init(window, document) {require('../../common/vendors~home~index~profile~searchResult.js')(window, document);require('../../common/vendors~index~profile~searchResult.js')(window, document);require('../../common/vendors~home~index.js')(window, document);require('../../common/vendors~index.js')(window, document);require('../../common/default~home~index~searchResult.js')(window, document);require('../../common/default~home~index.js')(window, document);require('../../common/default~index~searchResult.js')(window, document);require('../../common/default~index~profile.js')(window, document);require('../../common/index.js')(window, document)}
